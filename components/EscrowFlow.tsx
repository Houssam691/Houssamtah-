const steps = [
  {
    icon: "💰",
    title: "يدفع المشتري",
    desc: "المبلغ يُحفظ في حساب الوساطة (Escrow) — ليس للبائع ولا للمشتري بعد.",
  ...
  },
  {
    ...
    desc: "الإدارة تؤكد الدفع، البائع يسلم الحساب، والمشتري يستلم ويختبر المنتج.",
  ...
  },
  {
    icon: "✅",
    title: "تسليم + إتمام",
    desc: "المشتري يؤكد الاستلام → الأموال تتحرر للبائع. الكل رابح.",
