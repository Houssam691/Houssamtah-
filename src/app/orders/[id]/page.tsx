      ...
      <div className="mt-6 grid gap-4">
        <section className="glass rounded-3xl p-5">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              <div className="text-xs font-bold text-white/50">البائع</div>
              <div className="mt-1 font-bold text-white">{order.seller_name || "—"}</div>
            </div>
            <div>
          ...
          {order.status === "delivered" && isAdmin && (
            <div className="mt-4">
              <button className="btn-primary" onClick={paySeller}>
                تأكيد الدفع للبائع
              </button>
            </div>
          )}
