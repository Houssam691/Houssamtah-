              ...
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-1 text-sm text-white/70">
                    المشتري: {dispute.buyer_name} • البائع: {dispute.seller_name || "—"}
                  </div>
        ...
        {selectedDispute && (
          <div className="glass rounded-3xl p-5 lg:sticky lg:top-6 lg:h-[calc(100vh-8rem)] lg:overflow-y-auto">
            ...
            <div className="grid gap-3">
              ...
              {selectedDispute.seller_id && (
                <div className="rounded-xl bg-white/5 px-4 py-3">
                  <div className="text-xs text-white/50">البائع</div>
                  <button className="text-sm font-bold text-white hover:text-indigo-200" onClick={() => router.push(`/admin/users/${selectedDispute.seller_id}`)}>
                    {selectedDispute.seller_name} ←
                  </button>
                </div>
              )}
              <div className="rounded-xl bg-white/5 px-4 py-3">
