        ...
        <section className="mt-6 animate-fade-in-up stagger-3">
          ...
          <div className="glass rounded-3xl p-5">
            <div className="flex items-center gap-4">
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-emerald-400 text-xl font-black text-white">
                {product.seller_name.charAt(0).toUpperCase()}
              </div>
              <div className="min-w-0 flex-1">
                <div className="text-lg font-black text-white">{product.seller_name}</div>
              </div>
            </div>
