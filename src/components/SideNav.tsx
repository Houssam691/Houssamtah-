...
export default function SideNav({ userId }: Props) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 right-0 z-[60] flex w-72 max-w-[calc(100vw-1.5rem)] flex-col border-l border-white/10 bg-zinc-950/95 backdrop-blur-xl transition-transform duration-300 ${open ? "translate-x-0" : "translate-x-full"}`}
      >
